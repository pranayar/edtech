...
app.config['MYSQL_PASSWORD'] = 'raakjsTkIIH7YHtqra0H'
app.config['MYSQL_DB'] = 'railway'
app.config['MYSQL_PORT']=7560
app.config['MYSQL_URL']='mysql://root:raakjsTkIIH7YHtqra0H@containers-us-west-67.railway.app:7560/railway'
